      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-[#050505]/80 backdrop-blur-md border-b border-white/5 py-4' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-2 group cursor-pointer">
            ...
            <span className="font-display font-black text-2xl uppercase tracking-tighter italic">Jaydeep Fitness</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-rose-600 rounded-[3rem] p-12 md:p-20 relative overflow-hidden group">
            ...
            <div className="relative z-10 max-w-2xl flex flex-col gap-8">
              ...
              <h2 className="text-4xl md:text-7xl font-display font-black uppercase italic tracking-tighter leading-none text-white">The <br /> Jaydeep <br /> Method</h2>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12">
          ...
          <div className="h-[400px] lg:h-auto overflow-hidden rounded-[2.5rem] border border-white/5 relative bg-[#111]">
            ...
            <div className="absolute inset-0 flex items-center justify-center flex-col gap-4">
              ...
              <span className="font-display font-black text-white text-xl tracking-tighter italic">Jaydeep Fitness</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="py-12 border-t border-white/5 bg-[#050505]">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display font-black text-xl uppercase tracking-tighter italic">Jaydeep Fitness</span>
          </div>
          ...
          <div className="text-[10px] uppercase font-bold tracking-widest text-white/20">
            © 2026 Jaydeep Fitness. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
